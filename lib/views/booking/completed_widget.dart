...
class CompletedWidget extends StatelessWidget {
  ...
  final List<BookingModel> bookingListModel = getUpComingList();
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          return inkWellWidget(
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => BookingDetail()));
            },
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Image.asset(data.chargerModel!.chargerImage ?? '',
                                height: 30,
                                width: 30,
                                fit: BoxFit.contain,
                              ),
                          ...
                          SizedBox(width: 8),
                          BookingWidget(
                              title: 'Max.power', subTitle: '${data.chargerModel!.chargerMaxPower} kw'),
                          SizedBox(width: 8),
                          Container(
                            height: 50,
                            width: 1,
                          ...
                          SizedBox(width: 8),
                          BookingWidget(title: 'Duration', subTitle: '${data.chargerModel!.totalHours} hours'),
                          SizedBox(width: 8),
                          Container(
                            height: 50,
                            width: 1,
                          ...
                          SizedBox(width: 8),
                          BookingWidget(title: 'Amount', subTitle: '\$${data.totalAmount}'),
                        ],
                      ),
                      SizedBox(height: 8),
                      Divider(height: 0),
